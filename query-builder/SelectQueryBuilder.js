...
var SelectQueryBuilder = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(SelectQueryBuilder, _super);
    ...
    SelectQueryBuilder.prototype.getRawMany = function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var queryRunner, transactionStartedByUs, results, error_2, rollbackError_1;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    SelectQueryBuilder.prototype.getRawAndEntities = function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var queryRunner, transactionStartedByUs, results, error_3, rollbackError_2;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        queryRunner = this.obtainQueryRunner();
    ...
    SelectQueryBuilder.prototype.getCount = function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var queryRunner, transactionStartedByUs, results, error_4, rollbackError_3;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.expressionMap.lockMode === "optimistic")
    ...
    SelectQueryBuilder.prototype.getManyAndCount = function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var queryRunner, transactionStartedByUs, entitiesAndRaw, cacheId, count, results, error_5, rollbackError_4;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.expressionMap.lockMode === "optimistic")
    ...
    SelectQueryBuilder.prototype.stream = function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var _a, sql, parameters, queryRunner, transactionStartedByUs, releaseFn, results, error_6, rollbackError_5;
            var _this = this;
    ...
    SelectQueryBuilder.prototype.createSelectExpression = function () {
        ...
        if (this.expressionMap.mainAlias.hasMetadata) {
            ...
            allSelects.push.apply(allSelects, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this.buildEscapedEntityColumnSelects(this.expressionMap.mainAlias.name, metadata)), false));
            excludedSelects.push.apply(excludedSelects, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this.findEntityColumnSelects(this.expressionMap.mainAlias.name, metadata)), false));
        }
        // add selects from joins
        this.expressionMap.joinAttributes
            .forEach(function (join) {
            if (join.metadata) {
                allSelects.push.apply(allSelects, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(_this.buildEscapedEntityColumnSelects(join.alias.name, join.metadata)), false));
                excludedSelects.push.apply(excludedSelects, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(_this.findEntityColumnSelects(join.alias.name, join.metadata)), false));
            }
            else {
    ...
    SelectQueryBuilder.prototype.buildEscapedEntityColumnSelects = function (aliasName, metadata) {
        ...
        var columns = [];
        if (hasMainAlias) {
            columns.push.apply(columns, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(metadata.columns.filter(function (column) { return column.isSelect === true; })), false));
        }
        columns.push.apply(columns, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(metadata.columns.filter(function (column) {
        ...
        var allColumns = (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(columns), false), (0, tslib_1.__read)(nonSelectedPrimaryColumns), false);
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = (0, tslib_1.__read)(this.createOrderByCombinedWithSelectExpression("distinctAlias"), 2), selects = _a[0], orderBys_1 = _a[1];
