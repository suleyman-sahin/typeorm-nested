    ...
    RdbmsSchemaBuilder.prototype.createMetadataTableIfNecessary = function (queryRunner) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.viewEntityToSyncMetadatas.length > 0 || (this.connection.driver instanceof PostgresDriver_1.PostgresDriver && this.connection.driver.isGeneratedColumnsSupported))) return [3 /*break*/, 2];
            ...
            return (0, tslib_1.__generator)(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _a = (0, tslib_1.__values)(this.entityToSyncMetadatas), _b = _a.next();
                        _d.label = 2;
                    case 2:
                                ...
                                switch (_e.label) {
                                    case 0:
                                        ...
                                        dropQueries = table.indices
                                            ...
                                            .map(function (tableIndex) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                            return (0, tslib_1.__generator)(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.trys.push([1, 6, 7, 8]);
                        _a = (0, tslib_1.__values)(this.viewEntityToSyncMetadatas), _b = _a.next();
                        _d.label = 2;
                    case 2:
                        if (!!_b.done) return [3 /*break*/, 5];
                        metadata = _b.value;
            ...
            return (0, tslib_1.__generator)(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        try {
                            for (_a = (0, tslib_1.__values)(this.queryRunner.loadedTables), _b = _a.next(); !_b.done; _b = _a.next()) {
                    ...
                    case 1:
                        ...
                        tablesWithFK_1 = (0, tslib_1.__values)(tablesWithFK), tablesWithFK_1_1 = tablesWithFK_1.next();
                        _e.label = 2;
                    case 2:
